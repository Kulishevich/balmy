    ...
    <>
      ...
      <div className="container">
        <div className="flex gap-[30px] mt-10">
          <button className="w-full h-[300px] flex flex-col items-center justify-center gap-8 bg-gray rounded-[5px] text-[20px] font-[600] hover:bg-light-gold hover:text-black">
